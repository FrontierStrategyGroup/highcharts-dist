...
(function (factory) {
    ...
    _registerModule(_modules, 'masters/modules/map.src.js', [_modules['Core/Globals.js'], _modules['Core/Axis/Color/ColorAxis.js'], _modules['Core/Chart/MapChart.js']], function (Highcharts, ColorAxis, MapChart) {
